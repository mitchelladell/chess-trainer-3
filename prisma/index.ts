...
async function main() {
  /*  const users = [
    { name: "mitchell", email: "mitchell@gmail.com", password: "ombarkab" },
    { name: "yahya", email: "yahya@gmail.com", password: "yahya" },
  ];
  ...
  const pgnData = [
...

    {
      name: "h6",
      value:
        "1. d4 Nf6 2. c4 c5 3. d5 e6 4. Nc3 exd5 5. cxd5 d6 6. Nf3 g6 7. Nd2 Bg7 8. Nc4 O-O 9. Bf4 b6 10. Bxd6 Re8 11. e3 Ne4 12. Nxe4 Rxe4 (12... f5 13. Nc3 Bxc3+ (13... h6 { strong move } 14. a3) 14. bxc3) 13. Bg3 b5 14. Nd6 Rb4 *",
    },
    {
      name: "tester",
      value:
  ...
  /*   for (const pgn of pgnData) {
    await prisma.pgn.create({
      data: pgn,
    });
  } */
}
